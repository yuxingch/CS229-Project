...
class RnnModel:
    ...
    def __init__(self, placeholder, min_step=10, state_dim=lstm_size):
        self.min_step = min_step
        self.state_dim = state_dim
        self.rnn_cell = tf.contrib.rnn.BasicLSTMCell(state_dim)
        # Initial state of the LSTM memory.
        self.music_input = placeholder['x']
        '''
        ...
        self.time_range = sample_length
        self.note_input_dim = vec_size
        self.note_out_dim = out_size
        self.targets_pitch = placeholder['y']
    ...
    def build(self):
        ...
        self.outputs, self.state = tf.nn.dynamic_rnn(self.rnn_cell, self.music_input,
        ...
        weights = tf.Variable(tf.random_normal([self.state_dim, out_size]))
        ...
        self.logits = tf.reshape(self.logits,[self.batch_size,self.time_range,self.note_input_dim])
